...
# EXCEPTION HANDLERS
#
# FastAPI has a powerful exception handling system. You can catch specific
# exceptions (like validation errors) and return custom responses.
# This keeps your API consistent — all errors go through the same format.
# You can also log exceptions here, which is great for debugging and monitoring.
# `register_exception_handlers` is a function we defined in app/exceptions.py
# that attaches our custom handlers to the app. It keeps this file clean and organised.
# ----------------------------------------------------------------------------- 
